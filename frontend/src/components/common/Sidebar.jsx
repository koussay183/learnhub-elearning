...
const Sidebar = ({ activePage, user }) => {
  ...
  return (
    <aside className="fixed top-16 left-0 bottom-0 w-64 bg-white border-r border-gray-200 hidden lg:flex flex-col z-40">
      {/* Navigation items */}
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {navItems.map((item) => {
          const isActive = activePage === item.label.toLowerCase() ||
            activePage === item.to.replace('/', '');
