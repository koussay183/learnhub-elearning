...
const MessageInput = ({ onSend, disabled = false, typingUser = null }) => {
  ...
  return (
    <div className="border-t border-gray-800 bg-[#111111] p-4">
      {typingUser && (
        <p className="text-xs text-gray-500 italic mb-2 ml-1">{typingUser} is typing...</p>
      )}
      <form onSubmit={handleSubmit} className="flex items-center gap-3">
        <input
          ...
          disabled={disabled}
          className="flex-1 px-4 py-2.5 bg-[#0a0a0a] border-2 border-gray-800 rounded-xl text-sm text-white placeholder-gray-600
